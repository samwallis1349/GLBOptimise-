...
/**
 * One shared WebIO, used to re-parse the source GLB fresh for every LOD
 * level (see LODEngine.js) — same reasoning as Reduce Polys: registering the
 * extensions alone is not enough, Draco/Meshopt-compressed GLBs also need
 * their codec supplied as a dependency or reading one throws from deep
 * inside the extension. Most already-optimised game assets are compressed,
 * so without this the app rejects exactly the files it exists to work on.
 *
