...
import { loadGlbForPreview } from './loadModel.js';

/**
 * The shared before/after comparison viewport.
 *
 * Wraps two of the app's existing Viewers — one for the original, one for
 * the processed model — and keeps them locked together. Both are created with
