...
export const TOOLS = [
  ...
  // ---------- Build & Repair ----------
  {
    ...
    name: 'Convert Files',
    route: '/convert-files',
    description: 'Convert supported 3D asset formats.',
    keywords: ['fbx', 'obj', 'gltf', 'usd', 'format'],
    icon: 'refresh-cw',
  ...
  },
  {
    ...
    route: '/glb-builder',
    description: 'Combine models and merge multiple GLBs into one.',
    keywords: ['combine', 'join', 'assemble', 'scene build'],
    icon: 'package-plus',
    thumbnail: '/thumbnails/glb-builder.webp',
    features: [
      { icon: 'package-plus', label: 'Combine' },
  ...
  // ---------- Inspect & Analyse ----------
  {
    ...
    name: 'Inspect GLB',
    route: '/inspect-glb',
    description: 'Analyse the contents and structure of GLB models.',
    keywords: ['inspect', 'debug', 'structure', 'validate', 'json'],
    icon: 'search',
